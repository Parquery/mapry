...
void some_graph_from(
  ...
  if (not value.isMember("array_of_arrays")) {
    ...
    if (not value_0.isArray()) {
      ...
      std::vector<std::vector<bool>>& target_0 = target->array_of_arrays;
      ...
      for (const Json::Value& item_0 : value_0) {
        if (not item_0.isArray()) {
          ...
          std::vector<bool>& target_1 = target_0.at(i_0);
...
Json::Value serialize_some_graph(
  ...
  const auto& vector_0 = some_graph.array_of_arrays;
  for (int i_0 = 0;
      i_0 < vector_0.size();
      ++i_0) {
    Json::Value target_1(Json::arrayValue);
    const auto& vector_1 = vector_0[i_0];
    for (int i_1 = 0;
        i_1 < vector_1.size();
        ++i_1) {
  ...
  some_graph_as_value["array_of_arrays"] = std::move(target_0);
