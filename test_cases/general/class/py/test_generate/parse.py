...
def placeholder_with_reference(
        id: str) -> some.graph.WithReference:
    """
    creates a placeholder instance of WithReference.
    ...
    :return: empty shell
    """
    return some.graph.WithReference(  # type: ignore
        id=id,
        reference_to_an_empty=None,
        array_of_empties=None,
        map_of_empties=None)
...
def placeholder_some_graph() -> some.graph.SomeGraph:
    ...
    return some.graph.SomeGraph(  # type: ignore
        global_reference_to_an_empty=None)
