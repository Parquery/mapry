...
def placeholder_embed_with_ref() -> some.graph.EmbedWithRef:
    """
    creates a placeholder instance of EmbedWithRef.
    ...
    :return: empty shell
    """
    return some.graph.EmbedWithRef(  # type: ignore
        reference_to_empty=None)
