...
Json::Value serialize_some_graph(
  ...
  some_graph_as_value["some_time"] = tm_to_string(
    some_graph.some_time,
    "%H-%M-%S");

  some_graph_as_value["formatless_time"] = tm_to_string(
    some_graph.formatless_time,
    "%H:%M:%S");
